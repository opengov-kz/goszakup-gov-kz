...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('v3_plans.log'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger(__name__)

class GoszakupPlansParser:
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="Goszakup Plans API Parser")
    parser.add_argument(
        "--token",
        required=True,
